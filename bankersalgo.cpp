...
void
showTheInfo (struct process_info process[no_of_process])
{
...
//Apply safety algo
bool
applySafetyAlgo (struct process_info process[no_of_process],
		 int available[no_of_resources],
...
bool
isSafeState (struct process_info process[no_of_process],
	     int available[no_of_resources], int safeSequence[no_of_process])
{
